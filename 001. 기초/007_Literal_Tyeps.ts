...
let 이름8: 123; // 이름8에는 123만 들어올 수 있음
// 이름8 = 456; //에러뜸 123이 아니기 때문

//------------------------------------------------------------//

// 변수
let 놀이공원: '롤러코스터' | '후룸라이드';
놀이공원 = '롤러코스터';

// 함수
function 함1(a: 'hello') : 1 | 0 { //함수파라미터에 hello만 들어오도록 제한 / return 값으로 1과 0만 받도록 제한
    return 1;
};
...
const 변수10 = 'ham'; //const 변수는 1개의 값만, 값을 바꿀 수 없는 변수
let 변수11: '롤코' | '후룸'; // 롤코or후룸 중에 하나 (const 변수 업글버전이라 생각)
...
function 내함수네(a : 'ham') { //'ham'이라는 자료만 들어올 수 있음(x)/'ham'이라는 타입만 들어올 수 있음(O)
